...
type GoodsCategoryCrud struct {

}

func NewGoodsCategoryCrud() *GoodsCategoryCrud {
	return new(GoodsCategoryCrud)
}
...
//列表查询
func (s *GoodsCategoryCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *GoodsCategoryCrud) GetById(id int) (*models.GoodsCategory, error) {
...
// 删除 单条记录
func (s *GoodsCategoryCrud) Delete(id int) (int64, error) {
	m:=new(models.GoodsCategory)
	m.Id = id
