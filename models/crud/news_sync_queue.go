...
type NewsSyncQueueCrud struct {

}

func NewNewsSyncQueueCrud() *NewsSyncQueueCrud {
	return new(NewsSyncQueueCrud)
}
...
//列表查询
func (s *NewsSyncQueueCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *NewsSyncQueueCrud) GetById(id int) (*models.NewsSyncQueue, error) {
...
// 删除 单条记录
func (s *NewsSyncQueueCrud) Delete(id int) (int64, error) {
	m:=new(models.NewsSyncQueue)
	m.Id = id
