...
type UserProfileCrud struct {

}

func NewUserProfileCrud() *UserProfileCrud {
	return new(UserProfileCrud)
}
...
//列表查询
func (s *UserProfileCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *UserProfileCrud) GetById(id int) (*models.UserProfile, error) {
...
// 删除 单条记录
func (s *UserProfileCrud) Delete(id int) (int64, error) {
	m:=new(models.UserProfile)
	m.Id = id
