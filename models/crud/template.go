...
type TemplateCrud struct {

}

func NewTemplateCrud() *TemplateCrud {
	return new(TemplateCrud)
}
...
//列表查询
func (s *TemplateCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *TemplateCrud) GetById(id int) (*models.Template, error) {
...
// 删除 单条记录
func (s *TemplateCrud) Delete(id int) (int64, error) {
	m:=new(models.Template)
	m.Id = id
