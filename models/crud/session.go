...
//列表查询
func (s *SessionCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
	m := models.NewSession()
...
// 获取 单条记录
func (s *SessionCrud) GetById(id int) (*models.Session, error) {
...
// 删除 单条记录
func (s *SessionCrud) Delete(id int) (int64, error) {
	m:=new(models.Session)
	m.Id = id
