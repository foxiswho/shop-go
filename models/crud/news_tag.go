...
type NewsTagCrud struct {

}

func NewNewsTagCrud() *NewsTagCrud {
	return new(NewsTagCrud)
}
...
//列表查询
func (s *NewsTagCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
	m := models.NewNewsTag()
...
// 获取 单条记录
func (s *NewsTagCrud) GetById(id int) (*models.NewsTag, error) {
...
// 删除 单条记录
func (s *NewsTagCrud) Delete(id int) (int64, error) {
	m:=new(models.NewsTag)
	m.Id = id
