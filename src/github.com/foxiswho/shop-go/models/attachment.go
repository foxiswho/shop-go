...
type Attachment struct {
	AttachmentId int       `json:"attachment_id" xorm:"not null pk autoincr comment('附件ID') INT(10)"`
	...
	TimeAdd      time.Time `json:"time_add" xorm:"not null default 'CURRENT_TIMESTAMP' comment('添加时间上传时间') TIMESTAMP"`
	...
	Id           int       `json:"id" xorm:"not null default 0 comment('所属ID') index INT(10)"`
