...
type OrderCrud struct {

}

func NewOrderCrud() *OrderCrud {
...
//列表查询
func (s *OrderCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
	m := models.NewOrder()
...
// 获取 单条记录
func (s *OrderCrud) GetById(id int) (*models.Order, error) {
    m:=new(models.Order)
	m.Id = id
...
// 删除 单条记录
func (s *OrderCrud) Delete(id int) (int64, error) {
	m:=new(models.Order)
	m.Id = id
