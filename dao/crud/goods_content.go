...
type GoodsContentCrud struct {

}

func NewGoodsContentCrud() *GoodsContentCrud {
	return new(GoodsContentCrud)
}
...
//列表查询
func (s *GoodsContentCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *GoodsContentCrud) GetById(id int) (*models.GoodsContent, error) {
...
// 删除 单条记录
func (s *GoodsContentCrud) Delete(id int) (int64, error) {
	m:=new(models.GoodsContent)
	m.Id = id
