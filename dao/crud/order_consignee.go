...
type OrderConsigneeCrud struct {

}

func NewOrderConsigneeCrud() *OrderConsigneeCrud {
	return new(OrderConsigneeCrud)
}
...
//列表查询
func (s *OrderConsigneeCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *OrderConsigneeCrud) GetById(id int) (*models.OrderConsignee, error) {
...
// 删除 单条记录
func (s *OrderConsigneeCrud) Delete(id int) (int64, error) {
	m:=new(models.OrderConsignee)
	m.Id = id
