...
type AdminRolePrivCrud struct {

}

func NewAdminRolePrivCrud() *AdminRolePrivCrud {
	return new(AdminRolePrivCrud)
}
...
//列表查询
func (s *AdminRolePrivCrud) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
...
// 获取 单条记录
func (s *AdminRolePrivCrud) GetById(id int) (*models.AdminRolePriv, error) {
...
// 删除 单条记录
func (s *AdminRolePrivCrud) Delete(id int) (int64, error) {
	m:=new(models.AdminRolePriv)
	m.Id = id
